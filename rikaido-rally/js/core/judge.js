...
export function loosen(normalized) {
  return toKatakana(normalized).replace(/[\u30fc\uff70]/g, '');
}
...
export function contains(prepared, needle) {
...
export function checkGroup(prepared, group) {
  let matched = null;
 ...
 */
export function evaluate(question, input) {
...
export const RULE_TEXT = '正解 = 必須観点のすべてで、候補語のいずれか1語が回答に含まれること。'
